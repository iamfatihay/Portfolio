    ...
    return (
        <div className="home__data">
            ...
            <p className="home__description">
                Success is the story of those who can turn challenges into
                opportunities. Be courageous when faced with obstacles and find
                an opportunity to grow in every difficulty.
            </p>
